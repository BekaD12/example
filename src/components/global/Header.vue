  ...
  <div class="header-container" :class="currentPath">
      ...
      <nav class="header" :class="{ 'menu-active': isActive }">
        ...
        <div class="header-middle menu">
          <div class="menu-inner">
            ...
            <router-link class="menu-item blog" to="/blog">
              Blog
            </router-link>
            <router-link class="menu-item contact" to="/contact">
              Contact
            </router-link>
    ...
    <nav class="burger-container">
      <div class="burger-content">
        <svg
          class="burger rotate" viewBox="0 0 100 100" width="45" :class="{ active: isActive }" @click="
            toggleActive"
        >
